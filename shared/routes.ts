  ...
  auth: {
    signup: {
      ...
      input: z.object({
        ...
        // 필수 동의 항목
        agreements: z.object({
          terms: z.boolean(), // 서비스 이용약관
          privacy: z.boolean(), // 개인정보 수집·이용
          location: z.boolean(), // 위치정보 수집·이용
          payment: z.boolean(), // 결제·정산 정책
          liability: z.boolean(), // 책임 제한
          electronic: z.boolean(), // 전자계약 및 고지
          marketing: z.boolean().optional(), // [선택] 마케팅
          // 헬퍼 전용
          industrialAccidentInsurance: z.boolean().optional(), // 산재보험 안내 확인
          cargoInsurance: z.boolean().optional(), // 적재물배상책임보험 안내
          independentContractor: z.boolean().optional(), // 독립사업자 관계 확인
        }),
      }),
      responses: {
        201: z.object({
