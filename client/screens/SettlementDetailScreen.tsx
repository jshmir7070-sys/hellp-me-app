...
export default function SettlementDetailScreen({ route }: SettlementDetailScreenProps) {
  ...
  return (
    ...
    >
      <Card variant="glass" padding="lg" style={styles.headerCard}>
      ...
      <Card variant="glass" padding="md" style={styles.amountCard}>
        <ThemedText style={[styles.sectionTitle, { color: theme.text }]}>
          정산 내역
        </ThemedText>
      ...
      {dynamicFieldEntries.length > 0 ? (
        <Card variant="glass" padding="md" style={styles.dynamicFieldsCard}>
          <ThemedText style={[styles.sectionTitle, { color: theme.text }]}>
            추가 입력 항목
          </ThemedText>
      ...
      {workDetail.closingText ? (
        <Card variant="glass" padding="md" style={styles.memoCard}>
          <ThemedText style={[styles.sectionTitle, { color: theme.text }]}>
            특이사항
          </ThemedText>
      ...
      {workDetail.deliveryHistoryImages && workDetail.deliveryHistoryImages.length > 0 ? (
        <Card variant="glass" padding="md" style={styles.imagesCard}>
          <ThemedText style={[styles.sectionTitle, { color: theme.text }]}>
