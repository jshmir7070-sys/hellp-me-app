...
export default function HelpScreen({ navigation }: HelpScreenProps) {
  ...
  return (
    ...
    >
      <Card variant="glass" padding="lg" style={styles.introCard}>
      ...
      {helpSections.map((section) => {
        ...
        return (
          <View key={section.id} style={styles.sectionContainer}>
            <Card variant="glass" padding="md" style={styles.sectionHeader} onPress={() => toggleSection(section.id)} pressable>
      ...
      <Card variant="glass" padding="lg" style={styles.contactCard}>
