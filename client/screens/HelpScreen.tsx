...
const HELPER_HELP_SECTIONS: HelpSection[] = [
    ...
    items: [
      {
        ...
        answer: '헬퍼 활동을 시작하는 방법:\n\n[1단계] 회원가입\n• 이메일/비밀번호 입력\n• 휴대폰 본인인증\n• 기본 정보 입력 (이름, 차량 정보 등)\n\n[2단계] 서류 제출\n• 사업자등록증\n• 운전면허증\n• 화물운송종사자격증\n• 차량등록증\n* 나의정보 > 서류 제출에서 촬영 또는 갤러리 선택\n\n[3단계] 승인 대기\n• 관리자 검토 (1-2영업일)\n• 승인 완료 시 푸시 알림\n\n[4단계] 오더 지원\n• 오더 탭에서 오더 목록 확인\n• 오더 카드 터치 → 상세 페이지 이동\n• 조건 확인 후 "신청" 버튼 터치\n\n[5단계] 매칭 및 업무 시작\n• 요청자가 선택하면 알림 발송\n• 홈 화면 캘린더에서 매칭된 일정 확인\n• 해당 날짜의 오더 카드 터치 → QR 체크인 화면으로 바로 이동\n• QR 스캔 또는 12자리 코드 입력으로 출근 체크',
      },
      {
        question: '서류 제출 방법',
        answer: '필요 서류 및 제출 방법:\n\n[필수 서류]\n1. 사업자등록증\n   - 개인사업자 또는 법인사업자\n   - 최신 발급본 권장\n\n2. 운전면허증\n   - 1종 보통 이상\n   - 유효기간 확인\n\n3. 화물운송종사자격증\n   - 유효한 자격증\n\n4. 차량등록증\n   - 본인 명의 또는 회사 명의\n   - 차량 종류 확인 (봉고, 포터, 탑차 등)\n\n[제출 방법]\n나의정보 > 서류 제출\n→ 각 서류별 항목 선택\n→ 촬영 또는 갤러리에서 선택\n→ 업로드 후 제출 완료\n\n[주의사항]\n• 서류가 흐리거나 잘린 경우 반려될 수 있습니다\n• 승인까지 1-2영업일 소요\n• 홈 화면 상단 배너에서 승인 상태 확인 가능',
      },
      {
        question: '승인 상태 확인 방법',
        answer: '승인 상태는 여러 곳에서 확인할 수 있습니다:\n\n[확인 방법]\n1. 홈 화면 상단 배너\n   - 서류 미제출: "서류 제출이 필요합니다" 배너 표시\n   - 심사중: "서류 심사 중" 배너 표시\n   - 반려: "서류가 반려되었습니다" 배너 표시\n   - 배너 터치 시 서류 제출 화면으로 이동\n\n2. 나의정보 화면\n   - 현재 승인 상태 표시\n\n3. 푸시 알림\n   - 승인 완료/반려 시 알림 발송\n\n[승인 후]\n• 배너가 사라지고 캘린더와 일정 표시\n• 오더 지원 가능\n• 팀 생성/가입 가능',
      },
      {
        question: '프로필 설정하기',
        answer: '프로필 정보 관리:\n\n[기본 정보]\n나의정보 > 프로필 수정\n• 이름, 닉네임, 연락처\n• 프로필 이미지 (아바타 선택 또는 사진 업로드)\n\n[계좌 정보]\n나의정보 > 환불 계좌\n• 정산받을 계좌 등록\n• 예금주, 은행, 계좌번호\n\n[팁]\n• 프로필 사진/아바타를 등록하면 요청자에게 신뢰도가 올라갑니다\n• 닉네임을 설정하면 오더 지원 시 닉네임이 표시됩니다',
      },
    ],
  },
  {
    ...
    items: [
      {
        question: '오더 목록 확인하기',
        answer: '오더를 찾는 방법:\n\n[오더 탭]\n하단 탭바 "오더" 탭 선택\n• 현재 지원 가능한 오더 목록\n• 오더 카드 형태로 정보 표시\n\n[오더 카드 정보]\n• 택배사 (CJ, 롯데, 쿠팡 등)\n• 업체명\n• 배송 지역\n• 작업일 및 입차시간\n• 예상 물량 (박스 수)\n• 단가 (박스당 금액)\n• 차량 종류\n\n[오더 상세 페이지]\n오더 카드 터치 → 전체 화면 상세 페이지 이동\n• 캠프/터미널 주소 (복사 가능)\n• 입차시간\n• 배송가이드\n• 배송지역지도 (터치하여 확대)\n• 상세 설명, 요구사항\n• 하단 "신청" 버튼으로 지원',
      },
      {
        question: '오더 지원 방법',
        answer: '오더에 지원하는 방법:\n\n[지원 절차]\n1. 오더 탭에서 오더 카드 터치\n2. 상세 페이지에서 정보 확인\n3. 하단 "신청" 버튼 터치\n4. 지원 완료!\n\n[지원 시 주의]\n• 서류 승인이 완료되어야 지원 가능\n• 미승인 시 "서류 제출 필요" 안내 표시\n\n[지원 후]\n• 요청자가 지원자 목록에서 검토\n• 요청자가 선택하면 푸시 알림 발송\n• 홈 화면 캘린더에 일정 표시\n\n[주의사항]\n• 다른 헬퍼가 선택되면 자동 거절\n• 동시에 여러 오더 지원 가능',
      },
      {
        question: '홈 화면 캘린더 사용법',
        answer: '홈 화면에서 일정 관리:\n\n[캘린더]\n• 홈 화면 하단에 월간 캘린더 표시\n• 매칭된 오더가 있는 날짜에 색상 바 표시\n• 여러 오더가 있으면 여러 색상으로 구분\n\n[날짜 선택]\n• 캘린더에서 날짜 터치\n• 해당 날짜의 오더 카드가 상단에 표시\n• 좌우 스와이프로 여러 오더 확인\n\n[오더 카드 터치]\n• 매칭 완료(scheduled) 상태: QR 체크인 화면으로 바로 이동\n• 기타 상태: 오더 상세 페이지로 이동\n\n[월 이동]\n• 캘린더 상단 좌/우 화살표로 이전/다음 월 이동',
      },
      {
        question: '지원 취소하기',
  ...
  },
  {
    ...
    items: [
      {
        question: 'QR 출근 체크하기',
        answer: '출근 체크 방법 (2가지):\n\n[방법 1] 홈 화면에서 바로 체크인\n1. 홈 화면 캘린더에서 해당 날짜 선택\n2. 매칭된 오더 카드 터치\n3. QR 체크인 화면으로 자동 이동\n4. 요청자의 QR 코드 스캔 또는 12자리 코드 입력\n5. 체크인 완료!\n\n[방법 2] 나의정보에서 체크인\n1. 나의정보 탭 > "출근 체크" 메뉴\n2. "QR 스캔하기" 버튼 터치 → 카메라 스캔\n3. 또는 12자리 코드 직접 입력\n\n[방법 3] 오더 상세에서 체크인\n1. 오더 상세 페이지 접속\n2. 하단 "QR 체크인" 버튼 터치\n3. 카메라로 요청자 QR 스캔\n4. 또는 "QR 없이 시작" 버튼으로 즉시 시작\n\n[체크인 후]\n• 오더 상태가 "업무중"으로 변경\n• 요청자에게 알림 발송',
      },
      {
        question: '배송 업무 진행하기',
        answer: '업무 중 주의사항:\n\n[배송 전]\n• 물량 인수 시 박스 수량 확인\n• 파손/오배송 물품 체크\n• 특이사항 요청자에게 전달\n\n[배송 중]\n• 안전 운전\n• 물품 취급 주의\n• 배송 완료 시 사진 촬영 권장\n\n[배송 후]\n• 미배송/반품 물품 정리\n• 배송 이력 캡처 (쿠팡앱 등)\n• 마감 제출 준비\n\n[문제 발생 시]\n• 요청자에게 즉시 연락 (오더 상세에서 연락처 확인)\n• 파손/분실 시 사진 촬영\n• 나의정보 > 사고 신고에서 사고 접수 가능\n• 고객센터 문의',
      },
      {
        question: '마감 제출하기',
        answer: '마감 제출 방법:\n\n[오더 상세 페이지에서]\n1. 업무중인 오더의 상세 페이지 접속\n2. 하단 "마감 제출" 버튼 터치\n3. 배송 건수 입력\n4. 반품 건수 입력 (있는 경우)\n5. 배송 이력 이미지 첨부 (필수)\n6. 기타 이미지 첨부 (선택)\n7. "마감 제출" 버튼 터치\n\n[필수 첨부물]\n• 배송 이력 이미지\n  - 쿠팡앱 캡처 등\n  - 배송 완료 건수가 보이도록\n\n[제출 후]\n• 요청자가 검토 후 승인/반려\n• 승인되면 정산 진행\n• 반려 시 사유 확인 후 수정하여 재제출',
      },
      {
        question: '마감이 반려된 경우',
        answer: '마감 반려 시 대응:\n\n[반려 확인]\n• 푸시 알림으로 반려 알림\n• 오더 상세 페이지에서 반려 사유 확인\n  - 반려 카드가 빨간 테두리로 표시됨\n  - 반려 사유, 수정 안내 표시\n\n[재제출]\n1. 오더 상세 페이지에서 반려 사유 확인\n2. "마감 제출" 버튼으로 내용 수정\n3. 다시 제출\n\n[흔한 반려 사유]\n• 배송 건수 불일치\n• 이미지가 불분명함\n• 반품 수량 오류\n\n[문제 해결]\n• 반려 사유가 이해되지 않으면 요청자에게 연락\n• 계속 문제가 있으면 고객센터 문의',
      },
    ],
  },
  {
    ...
    items: [
      {
        question: 'QR 체크인 화면 접속 방법',
        answer: 'QR 체크인 화면에 접근하는 방법:\n\n[방법 1] 홈 화면에서 (가장 빠름)\n• 홈 캘린더에서 매칭된 날짜 선택\n• 해당 오더 카드 터치\n• 자동으로 QR 체크인 화면 이동\n\n[방법 2] 나의정보에서\n• 나의정보 탭 > "출근 체크" 메뉴\n\n[방법 3] 오더 상세에서\n• 오더 상세 페이지 하단 "QR 체크인" 버튼\n\n[QR 체크인 화면 구성]\n• 상단: QR 스캔 버튼 (카메라 실행)\n• 하단: 12자리 코드 직접 입력란\n• 요청자가 보여주는 QR을 스캔하거나\n  12자리 코드를 입력하면 출근 체크 완료',
      },
      {
        question: 'QR 스캔이 안 되는 경우',
        answer: 'QR 스캔 문제 해결:\n\n[확인사항]\n1. 카메라 권한 허용 여부\n2. QR 코드가 화면에 선명한지\n3. 조명이 충분한지\n4. 카메라 렌즈 청결 상태\n\n[대안: 12자리 코드 입력]\n1. QR 체크인 화면 하단\n2. 12자리 코드 입력란에 코드 입력\n3. 클립보드 붙여넣기도 가능\n4. "출근 확인" 버튼 터치\n\n[오더 상세에서 "QR 없이 시작"]\n• 오더 상세 페이지 하단\n• "QR 없이 시작" 버튼으로 즉시 업무 시작 가능\n\n[계속 안 되면]\n• 앱 재시작 후 다시 시도\n• 고객센터 문의',
      },
    ],
  },
  {
...
const REQUESTER_HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        question: '헬프미 앱 사용 단계',
        answer: '요청자로 시작하는 방법:\n\n[1단계] 회원가입\n• 이메일/비밀번호 입력\n• 휴대폰 본인인증\n• 사업체 정보 입력\n\n[2단계] 서류 제출\n• 나의정보 > 서류 제출\n• 사업자등록증 촬영/업로드\n\n[3단계] 승인 대기\n• 관리자 검토 (1-2영업일)\n• 승인 완료 시 푸시 알림\n\n[4단계] 오더 등록\n• 오더등록 탭에서 오더 등록\n• 배송 조건 입력\n• 계약금(20%) 결제\n\n[5단계] 헬퍼 선택\n• 홈 화면에서 지원한 헬퍼 카드 확인\n• 프로필, 평점, 리뷰 확인 후 선택\n• 매칭 완료!\n\n[6단계] 업무 관리\n• 나의정보 > 출근 체크에서 QR 보여주기\n• 헬퍼가 QR 스캔하면 출근 체크 완료\n• 마감 확인 및 잔금 결제',
      },
      {
        question: '사업체 인증하기',
        answer: '사업체 인증 절차:\n\n[필수 서류]\n• 사업자등록증\n  - 법인 또는 개인사업자\n  - 최신 발급본 권장\n\n[제출 방법]\n나의정보 > 서류 제출\n1. "사업자등록증" 선택\n2. 촬영 또는 갤러리에서 선택\n3. 업로드 완료\n\n[주의사항]\n• 서류가 선명하게 보여야 함\n• 사업자번호, 대표자명 확인\n• 휴/폐업 상태가 아니어야 함\n\n[승인 후]\n• 오더 등록 가능\n• 헬퍼 매칭 가능',
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: '오더 수정하기',
        answer: '오더 수정 방법:\n\n[수정 가능 시점]\n• 매칭 전 상태에서만 수정 가능\n• 상태: 등록완료, 매칭중, 계약금결제완료\n\n[수정 방법]\n1. 홈 화면에서 오더 카드 터치\n2. 오더 상세 페이지 이동\n3. 하단 "수정" 버튼 터치\n4. 수정 팝업에서 변경\n\n[수정 가능 항목]\n• 단가 (박스당 금액)\n• 작업 날짜\n\n[주의사항]\n• 매칭 완료 후에는 수정 불가\n• 택배사, 지역 등 기본 정보는 변경 불가\n  (취소 후 재등록 필요)',
      },
      {
        question: '오더 삭제/숨기기',
        answer: '오더 삭제 및 숨기기:\n\n[삭제]\n• 매칭 전 상태에서만 삭제 가능\n• 오더 상세 페이지 하단 "삭제" 버튼\n• 삭제 시 계약금 환불\n\n[숨기기]\n• 완료된 오더를 목록에서 숨김\n• 대상: 마감완료, 정산완료 등 종결된 오더\n• 오더 상세 페이지 하단 "숨기기" 버튼\n• 숨기기 후 목록에서 표시되지 않음\n\n[환불 정책]\n• 헬퍼 선택 전 삭제: 계약금 100% 환불\n• 헬퍼 선택 후: 삭제 불가 (환불 불가)\n  → 사유: 헬퍼가 다른 오더를 포기하고 배정되었기 때문',
      },
      {
        question: '금액 계산 방법',
  ...
  },
  {
    ...
    items: [
      {
        question: '지원자 확인하기',
        answer: '헬퍼 지원 확인:\n\n[홈 화면에서]\n• 오더 카드 하단에 지원한 헬퍼 표시\n• 최대 3명까지 카드 형태로 표시\n• 3명 초과 시 "전체보기" 버튼\n\n[헬퍼 프로필 확인]\n헬퍼 카드 터치 시 상세 프로필 팝업:\n• 프로필 사진/아바타\n• 닉네임 및 팀 정보\n• 평점 (별점 1~5)\n• 완료한 오더 수\n• 리뷰 수 및 최근 리뷰 내용\n• 지원 메시지 (있는 경우)\n\n[비교 포인트]\n• 평점 및 리뷰 내용\n• 수행 이력 건수\n• 팀 소속 여부',
      },
      {
        question: '헬퍼 선택하기',
        answer: '헬퍼를 선택하는 방법:\n\n[선택 절차]\n1. 홈 화면 오더 카드 하단 지원자 목록 확인\n2. 원하는 헬퍼 카드 터치\n3. 프로필 팝업에서 상세 정보 확인\n4. "선택하기" 버튼 터치\n5. 확인 후 매칭 완료!\n\n[선택 후]\n• 선택된 헬퍼에게 알림 발송\n• 다른 지원자들은 자동 거절됨\n• 오더 상태: "매칭완료"\n\n[오더 상세 확인]\n• 홈 화면 오더 카드 터치 → 상세 페이지\n• 매칭된 헬퍼 정보 확인 가능',
      },
      {
        question: '지원자가 없는 경우',
        answer: '지원자가 없을 때:\n\n[확인사항]\n• 단가가 적절한지\n• 지역이 너무 외진 곳인지\n• 일정이 급한지\n\n[해결방법]\n1. 단가 올리기\n   - 오더 상세 > "수정" 버튼 > 단가 변경\n\n2. 일정 조정\n   - 오더 상세 > "수정" 버튼 > 날짜 변경\n\n3. 오더 재등록\n   - 조건을 완화하여 새로 등록\n\n[오더 만료]\n• 7일간 지원자 없으면 자동 만료\n• 계약금 환불 처리\n• 오더 재등록 가능',
  ...
  },
  {
    ...
    items: [
      {
        question: 'QR 코드 보여주기',
        answer: '헬퍼 출근 체크 방법:\n\n[내 QR 코드 확인]\n나의정보 탭 > "출근 체크" 메뉴\n\n[화면 구성]\n• QR 코드 이미지 (헬퍼가 스캔)\n• 12자리 개인 코드 (복사/공유 가능)\n• 이름, 전화번호 정보\n\n[사용 방법]\n1. 헬퍼가 출근하면\n2. "출근 체크" 화면 열기\n3. 헬퍼에게 QR 보여주기\n4. 헬퍼가 스캔하면 체크인 완료!\n\n[체크인 완료 후]\n• 오더 상태가 "업무중"으로 변경\n• 푸시 알림으로 체크인 확인\n\n[코드 직접 전달]\n• QR 스캔이 어려운 경우\n• "코드 복사" 버튼으로 12자리 코드 복사\n• "공유하기" 버튼으로 카카오톡 등으로 전송 가능\n• 헬퍼가 코드를 직접 입력',
      },
      {
        question: 'QR 코드 관련 문제',
        answer: 'QR 코드 문제 해결:\n\n[QR 코드는 분실되지 않습니다]\n• 앱에서 언제든 확인 가능\n• 나의정보 > 출근 체크\n\n[화면이 안 보이는 경우]\n• 앱을 완전히 종료 후 재시작\n• 로그아웃 후 다시 로그인\n\n[코드가 작동 안 하는 경우]\n• 화면 밝기 최대로\n• 헬퍼 앱 재시작 요청\n• 12자리 코드를 직접 전달\n• 고객센터 문의',
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        question: '리뷰 작성하기',
        answer: '헬퍼 리뷰 작성 방법:\n\n[작성 시점]\n• 마감 승인 및 잔금 결제 완료 후\n\n[작성 방법]\n1. 리뷰 탭에서 작성 가능한 오더 확인\n2. 별점 선택 (1~5점)\n3. 리뷰 내용 작성\n4. 제출\n\n[리뷰 포인트]\n• 시간 준수 여부\n• 배송 품질\n• 소통 및 태도\n• 재이용 의사',
      },
      {
        question: '리뷰가 중요한 이유',
        answer: '리뷰의 중요성:\n\n[헬퍼에게]\n• 평점이 프로필에 표시됨\n• 좋은 리뷰는 매칭 확률 상승\n• 지원자 선택 시 다른 요청자의 리뷰 참고 가능\n\n[다른 요청자에게]\n• 헬퍼 선택 시 참고 자료\n• 실제 업무 경험 공유\n• 신뢰할 수 있는 정보',
      },
    ],
  },
];
