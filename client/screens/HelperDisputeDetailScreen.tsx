...
export default function HelperDisputeDetailScreen({ route }: HelperDisputeDetailScreenProps) {
  ...
  return (
    <DisputeDetailView dispute={dispute} statusLabels={DISPUTE_STATUS_CONFIG}>
      ...
      {(dispute.status === "resolved" && dispute.resolvedAmount !== null) ? (
        <View style={[styles.amountSection, { backgroundColor: theme.backgroundDefault, marginTop: Spacing.sm }]}>
          <ThemedText style={[styles.amountLabel, { color: theme.tabIconDefault }]}>결정 금액</ThemedText>
