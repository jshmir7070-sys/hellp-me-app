    ...
    <View style={styles.headerContent}>
      ...
      {bannerContent ? (
        <Card
          ...
          style={[styles.onboardingBanner, { borderColor: bannerContent.color }]}
        >
      ...
      {isLoadingStats ? (
        <Card variant="glass" padding="xl" style={styles.statsCard}>
...
function SimpleCalendar({ 
  ...
  return (
    <Card variant="glass" padding="lg" style={styles.calendarCard}>
              ...
              return (
                <View key={order.id} style={styles.swipeOrderCard}>
                  ...
                  {(order.applicants && order.applicants.length > 0) ? (
                    <View style={styles.fbMiniCardsRow}>
                      {order.applicants.slice(0, 3).map((applicant: any) => (
                        <Pressable 
                          key={applicant.id} 
                          style={styles.fbMiniCard} 
                        ...
                        >
                          ...
                          />
                          <View style={styles.fbMiniProfileArea}>
                            <View style={styles.fbMiniAvatarCircle}>
                              {applicant.profileImageUrl ? (
                                <Image 
                                  source={{ uri: `${getApiUrl()}${applicant.profileImageUrl}` }}
                                  style={styles.fbMiniAvatarImage}
                                />
                              ) : (
                    ...
                    <View style={styles.noApplicantRow}>
                      <ThemedText style={[styles.noApplicantText, { color: theme.tabIconDefault }]}>신청 헬퍼 없음</ThemedText>
                    </View>
                  )}
                </View>
              );
