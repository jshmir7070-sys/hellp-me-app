...
type ReviewListScreenProps = NativeStackScreenProps<ReviewStackParamList, 'ReviewList'>;

export default function ReviewListScreen({ navigation }: ReviewListScreenProps) {
  ...
  const QuickAccessMenu = (
    <View style={[styles.menuSection, { backgroundColor: theme.backgroundRoot }]}>
      <View style={styles.menuGrid}>
        ...
        >
          <View style={[styles.menuIconContainer, { backgroundColor: BrandColors.requesterLight }]}>
            <Icon name="time-outline" size={24} color={BrandColors.requester} />
          </View>
