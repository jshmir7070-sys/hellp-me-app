    ...
    <View style={[styles.container, { backgroundColor: theme.backgroundRoot }]}>
      ...
      >
        ...
        {(order.deliveryGuide || order.deliveryGuideUrl) ? (
          <Card variant="glass" padding="lg" style={styles.guideCard}>
        ...
        {order.description ? (
          <Card variant="glass" padding="lg" style={styles.descriptionCard}>
        ...
        {order.requirements ? (
          <Card variant="glass" padding="lg" style={styles.requirementsCard}>
