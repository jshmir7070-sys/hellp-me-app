...
export function ClosingInputScreen({ route, navigation }: any) {
  ...
  return (
    ...
    >
      <Card variant="glass" padding="md" style={styles.orderSummary}>
      ...
      <Card variant="outline" padding="md" style={styles.warningCard}>
      ...
      <Card variant="glass" padding="md" style={styles.inputCard}>
      ...
      <Card variant="glass" padding="md" style={styles.imageCard}>
