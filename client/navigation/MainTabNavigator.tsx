    ...
    <Tab.Navigator
      ...
      screenOptions={{
        ...
        tabBarStyle: showSidebar ? {
          ...
          borderRightWidth: 1,
          borderRightColor: theme.backgroundSecondary,
        } : {
          position: "absolute",
          backgroundColor: Platform.select({
            ios: "transparent",
            android: PremiumColors.glassMedium,
          }),
          borderTopWidth: 0,
          elevation: Platform.OS === 'android' ? 16 : 0,
          paddingBottom: insets.bottom,
          height: 60 + insets.bottom,
          borderTopLeftRadius: Platform.OS === 'android' ? BorderRadius.lg : 0,
          borderTopRightRadius: Platform.OS === 'android' ? BorderRadius.lg : 0,
        },
