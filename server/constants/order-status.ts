...
const VALID_TRANSITIONS: Record<OrderStatus, OrderStatus[]> = {
  ...
  [ORDER_STATUS.CLOSING_SUBMITTED]: [ORDER_STATUS.FINAL_AMOUNT_CONFIRMED, ORDER_STATUS.IN_PROGRESS],
  [ORDER_STATUS.FINAL_AMOUNT_CONFIRMED]: [ORDER_STATUS.BALANCE_PAID, ORDER_STATUS.CLOSING_SUBMITTED],
  [ORDER_STATUS.BALANCE_PAID]: [ORDER_STATUS.SETTLEMENT_PAID, ORDER_STATUS.FINAL_AMOUNT_CONFIRMED],
  [ORDER_STATUS.SETTLEMENT_PAID]: [ORDER_STATUS.CLOSED],
  [ORDER_STATUS.CLOSED]: [],
